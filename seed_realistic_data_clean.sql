...
-- CLEAN VERSION: All UUIDs are properly formatted and valid
...
INSERT INTO public.bookings (
  ...
  (
    ...
    '10000000-1000-1000-1000-100000000001', -- VW Golf
    '11111111-1111-1111-1111-111111111111', -- Sarah Johnson
  ...
  (
    '20000000-2000-2000-2000-200000000003',
  ...
  (
    '20000000-2000-2000-2000-200000000004',
    '10000000-1000-1000-1000-100000000002', -- Tesla Model 3
    '22222222-2222-2222-2222-222222222222', -- Ahmed Benali
    '44444444-4444-4444-4444-444444444444', -- Fatima Boudiaf
  ...
  (
    '20000000-2000-2000-2000-200000000005',
...
INSERT INTO public.reviews (
  ...
  (
    '30000000-3000-3000-3000-300000000003',
    '20000000-2000-2000-2000-200000000004',
    '22222222-2222-2222-2222-222222222222', -- Ahmed Benali
    '44444444-4444-4444-4444-444444444444', -- Fatima Boudiaf
    '10000000-1000-1000-1000-100000000002', -- Tesla Model 3
...
-- =====================================================
-- 8. ADMIN ACTIONS/LOGS (Clean UUIDs)
-- =====================================================
...
-- =====================================================
-- 9. ADDITIONAL REALISTIC DATA (Clean UUIDs)
-- =====================================================
...
INSERT INTO public.notifications (
  ...
  (
    ...
    'success',
    false,
    '{"booking_id": "20000000-2000-2000-2000-200000000002", "car_name": "Volkswagen Golf 2022"}',
  ...
  (
    ...
    'info',
    true,
    '{"request_id": "40000000-4000-4000-4000-400000000001"}',
