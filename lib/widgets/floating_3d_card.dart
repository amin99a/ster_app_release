...
class Floating3DCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: isPressed ? _getPressedShadows() : _getNormalShadows(baseElevation),
      ),
      child: Material(
  ...
  List<BoxShadow> _getNormalShadows(double baseElevation) {
    return [
      ...
      BoxShadow(
        color: const Color(0xFF353935).withValues(alpha: 0.13),
      ...
      BoxShadow(
        color: const Color(0xFF353935).withValues(alpha: 0.08),
      ...
      BoxShadow(
        color: const Color(0xFF353935).withValues(alpha: 0.06),
      ...
      BoxShadow(
        color: const Color(0xFF353935).withValues(alpha: 0.04),
...
class _Floating3DButtonState extends State<Floating3DButton> {
  ...
  @override
  Widget build(BuildContext context) {
    final bgColor = widget.backgroundColor ?? const Color(0xFF353935);
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: _isPressed || !widget.enabled ? _getPressedShadows() : _getNormalShadows(),
        ),
  ...
  List<BoxShadow> _getNormalShadows() {
      ...
      // Primary shadow
      BoxShadow(
        color: const Color(0xFF353935).withValues(alpha: 0.25),
        blurRadius: 12,
      ...
      // Secondary shadow
      BoxShadow(
        color: const Color(0xFF353935).withValues(alpha: 0.12),
        blurRadius: 24,
  ...
  List<BoxShadow> _getPressedShadows() {
    return [
      BoxShadow(
        color: const Color(0xFF353935).withValues(alpha: 0.16),
        blurRadius: 6,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          // Primary shadow
          BoxShadow(
            color: const Color(0xFF353935).withValues(alpha: 0.15),
            blurRadius: baseElevation * 1.5,
            offset: Offset(0, baseElevation * 0.5),
            spreadRadius: 0,
          ),
          // Secondary shadow
          BoxShadow(
            color: const Color(0xFF353935).withValues(alpha: 0.10),
            blurRadius: baseElevation * 2.5,
            offset: Offset(0, baseElevation * 0.8),
            spreadRadius: 0,
          ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          ...
          BoxShadow(
            color: const Color(0xFF353935).withValues(alpha: 0.18),
            blurRadius: 25,
