class LocalizationService {
  static const Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      'rtl_notice': 'This app supports right-to-left text direction for Arabic.',
      'test_localization': 'Test Localization',
      'test_dialog_title': 'Localization Test',
      'test_dialog_content': 'This dialog demonstrates localized text in action.',
    ...
    'fr': {
      ...
      'car_transmission': 'Transmission',
      'car_fuel_type': 'Type de carburant',
      'car_passengers': 'Passagers',
      'car_features': 'Caractéristiques',
      'per_day': 'par jour',
      ...
      'car_earnings': 'Revenus',
      'host_profile': 'Profil hôte',
      ...
      'error_authentication': 'Échec de l\'authentification. Connectez-vous à nouveau.',
      ...
      'rtl_notice': 'Cette application prend en charge la direction de texte de droite à gauche pour l\'arabe.',
      'test_localization': 'Tester la Localisation',
      'test_dialog_title': 'Test de Localisation',
      'test_dialog_content': 'Cette boîte de dialogue démontre le texte localisé en action.',
    ...
    'ar': {
      ...
      'rent_car': 'استئجار سيارة',
      'book_now': 'احجز الآن',
      'book_car': 'احجز السيارة',
      ...
      'car_passengers': 'الركاب',
      'car_features': 'المميزات',
      'per_day': 'يومياً',
      'per_week': 'أسبوعياً',
      'per_month': 'شهرياً',
      ...
      'booking_confirmed': 'مؤكدة',
      'booking_pending': 'قيد الانتظار',
      'booking_cancelled': 'ملغية',
      'booking_completed': 'مكتملة',
      ...
      'my_cars': 'سياراتي',
      'add_car': 'إضافة سيارة',
      'car_earnings': 'الأرباح',
      'host_profile': 'ملف المضيف',
      ...
      'rtl_notice': 'يدعم هذا التطبيق اتجاه النص من اليمين إلى اليسار للغة العربية.',
