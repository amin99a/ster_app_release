...
class ErrorHandlingService {
  ...
  static String getErrorMessage(String errorType, {String? customMessage}) {
    switch (errorType) {
      case networkError:
        return customMessage ?? 'No internet connection. Please check your network and try again.';
      case serverError:
        return customMessage ?? 'Server is temporarily unavailable. Please try again later.';
      case dataError:
        return customMessage ?? 'Unable to load data. Please refresh and try again.';
      case authError:
          ...
          if (showIcon) ...[
            Container(
              ...
              decoration: BoxDecoration(
                color: getErrorColor(errorType).withOpacity(0.1),
