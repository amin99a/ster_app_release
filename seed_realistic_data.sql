...
-- =====================================================
-- 2. DEMO USERS (Realistic profiles)
-- =====================================================

-- Insert demo auth users first (Note: In real Supabase, you'd create these via Auth)
-- For demo purposes, we'll create user_profiles directly
...
-- =====================================================
-- 4. BOOKINGS (Realistic booking history)
-- =====================================================
...
-- =====================================================
-- 6. HOST REQUESTS (Become Host Applications)
-- =====================================================
...
INSERT INTO public.host_requests (
  ...
  (
    ...
    'nnnnnnnn-nnnn-nnnn-nnnn-nnnnnnnnnnnn', -- Fictitious user ID
    'I want to rent my car.',
    'rejected',
    '55555555-5555-5555-5555-555555555555', -- Admin Hadj
    '2024-10-20 11:15:00+00',
    '2024-10-18 13:20:00+00'
  );

-- =====================================================
-- 7. ADMIN ACTIONS/LOGS (Administrative activities)
-- =====================================================
...
INSERT INTO public.admin_logs (
  ...
  (
    ...
    'host_requests',
    'mmmmmmmm-mmmm-mmmm-mmmm-mmmmmmmmmmmm',
    '{"reason": "Insufficient documentation provided", "user_name": "John Doe", "action_taken": "Rejected due to incomplete application"}',
    '2024-10-20 11:15:00+00'
  ),
  ...
  (
    ...
    'REVIEW_MODERATED',
    'reviews',
    'rrrrrrrr-rrrr-rrrr-rrrr-rrrrrrrrrrrr', -- Fictitious review ID
...
BEGIN
  ...
  RAISE NOTICE '- 2 Customers: Sarah Johnson, Ahmed Benali';
  RAISE NOTICE '- 2 Hosts: Mohamed Kaci, Fatima Boudiaf';
  RAISE NOTICE '- 1 Admin: Admin Hadj';
  RAISE NOTICE '- 1 Pending Host: Yacine Meziani';
  RAISE NOTICE '';
