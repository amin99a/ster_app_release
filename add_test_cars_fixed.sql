-- STER Car Rental App - Add Test Cars (Fixed)
...
BEGIN
    ...
    -- Insert sample cars (fixed with both price and price_per_day)
    INSERT INTO public.cars (
        id, name, image, price, price_per_day, category_id, rating, trips,
